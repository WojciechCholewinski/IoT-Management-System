...
class ShteyButtonWidget extends StatefulWidget {
  const ShteyButtonWidget({
    super.key,
    required this.text,
  ...
  final ShteyButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<ShteyButtonWidget> createState() => _ShteyButtonWidgetState();
}

class _ShteyButtonWidgetState extends State<ShteyButtonWidget> {
  bool loading = false;
