...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _IoT_ButtonTabBarState tabBar;
...
/// A  Designed widget that displays a horizontal row of tabs.
class IoT_ButtonTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [IoT_ButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<IoT_ButtonTabBar> createState() => _IoT_ButtonTabBarState();
}

class _IoT_ButtonTabBarState extends State<IoT_ButtonTabBar>
  ...
  @override
  void didUpdateWidget(IoT_ButtonTabBar oldWidget) {
