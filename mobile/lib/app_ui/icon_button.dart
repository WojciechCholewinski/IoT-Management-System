...
class IotIconButton extends StatefulWidget {
  const IotIconButton({
    super.key,
    required this.icon,
    this.borderColor,
  ...
  @override
  State<IotIconButton> createState() => _IotIconButtonState();
}

class _IotIconButtonState extends State<IotIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(IotIconButton oldWidget) {
