...
abstract class IoT_Theme {
  ...
  static IoT_Theme of(BuildContext context) {
...
class LightModeTheme extends IoT_Theme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
...
class DarkModeTheme extends IoT_Theme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
