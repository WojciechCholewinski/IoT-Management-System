...
class ShteyUploadedFile {
  const ShteyUploadedFile({
    this.name,
    this.bytes,
    this.height,
    this.width,
  ...
  @override
  String toString() =>
      'ShteyUploadedFile(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash,)';
  ...
  static ShteyUploadedFile deserialize(String val) {
