...
Widget wrapWithModel<T extends IotModel>({
  required T model,
...
T createModel<T extends IotModel>(
...
abstract class IotModel<W extends Widget> {
...
class IotDynamicModels<T extends IotModel> {
  IotDynamicModels(this.defaultBuilder);
