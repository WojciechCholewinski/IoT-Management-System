...
namespace api.Migrations
{
    ...
    [Migration("20241102180200_ConfigureDeviceHierarchy")]
    partial class ConfigureDeviceHierarchy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Common.Entities.Device", b =>
                {
                    ...
                    b.HasDiscriminator<string>("DeviceType").HasValue("StandardDevice");
            ...
            modelBuilder.Entity("Common.Entities.AdvancedDevice", b =>
                {
                    ...
                    b.Property<long>("RealRuntimeTicks")
                        .HasColumnType("bigint");

                    b.Property<TimeSpan>("TimeOfWork")
                        .HasColumnType("time");

                    b.HasDiscriminator().HasValue("AdvancedDevice");
                });
